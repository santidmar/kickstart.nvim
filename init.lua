...
vim.keymap.set('n', '<leader>e', '<cmd>Explore<CR>', { desc = 'Open file [E]xplorer (netrw)' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    config = function()
      local wanted = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'prisma', 'query', 'vim', 'vimdoc' }
